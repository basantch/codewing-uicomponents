...
const RangeStyles = styled.div`
    ...
    > .components-base-control{
        ...
        .components-base-control__field{
            ...
            .components-range-control__track, span[class*="-Rail-railBackgroundColor"]{
                height: 6px;
            }
...
const RangeSlider = ({units, value, onChange, ...ControlGroup}) => {
    return <RangeStyles className={units ? 'cw__has-unit' : ''}>
            <RangeControl value={value.value} onChange={(val) => onChange({...value, value: val})} {...ControlGroup} />
            {
